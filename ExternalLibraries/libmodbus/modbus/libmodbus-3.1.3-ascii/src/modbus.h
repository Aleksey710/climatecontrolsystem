...
extern enum msg_type_t;

// Computes the length to read after the function received
MODBUS_API static uint8_t compute_meta_length_after_function(int function, msg_type_t msg_type);
// Computes the length to read after the meta information (address, count, etc)
MODBUS_API static int compute_data_length_after_meta(modbus_t *ctx, uint8_t *msg, msg_type_t msg_type);
MODBUS_API static void _sleep_response_timeout(modbus_t *ctx);
*/
//------------------------------------------------------------------------------------------------------------
