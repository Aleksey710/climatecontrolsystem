...
#include "../../InternalLibraries/ModbusWrapper/ModbusRTU.h"
...
const QMetaObject ModbusRTU::staticMetaObject = {
    { &ModbusSerial::staticMetaObject, qt_meta_stringdata_ModbusRTU.data,
      qt_meta_data_ModbusRTU,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ModbusRTU::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ModbusRTU.stringdata0))
        return static_cast<void*>(const_cast< ModbusRTU*>(this));
